...
class BacktestExecutionThread(QThread):
    ...
    def __init__(self, strategy: TradingStrategy, data: Dict[str, Any], config: BacktestParameters):
        super().__init__()
...
class ExecutionController(QObject):
    ...
    def run_backtest(self, strategy: TradingStrategy, data: Dict[str, Any], config: BacktestParameters) -> bool:
